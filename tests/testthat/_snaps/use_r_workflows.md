...
# use_r_cmd_check() works with depends on quarto
...
# use_r_cmd_check() works with depends on quarto and tmb
...
# use_r_cmd_check() works with additional_args, depends_on_tmb, and depends_on_quarto
