...
## Dependency graph
GitHub provides dependency graph to show the dependencies and dependents of the `ghactions4r` package. The figure below helps visualize the GitHub repos that are dependents of the `ghactions4r` GitHub Actions workflows.

<iframe
  src="./inst/extdata/dependency_graph/dependency_graph.html"
