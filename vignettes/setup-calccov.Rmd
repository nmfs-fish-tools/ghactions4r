...
Some workflows in `{ghactions4r}` take additional setup steps besides running the `use_*` function. Here is a detailed guide on the additional steps to be taken.
...
5) Try re-running your Code Coverage GitHub Action by pushing a new commit and see if your results go to the Codecov or Coveralls website.
