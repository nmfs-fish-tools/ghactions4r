...
GitHub provides dependency graph to show the dependencies and dependents of the `ghactions4r` package. The figure below helps visualize the GitHub repos that are dependents of the `ghactions4r` GitHub Actions workflows. We use `datastorm-open/DependenciesGraphs` to generate the dependents figure. The [DependenciesGraphs](https://github.com/datastorm-open/DependenciesGraphs) is an R package for dependencies visualization between packages and functions. 
